...
/**
 * Language description for Groovy
 * @author (adapted)
 */
public class GroovyDescription implements LanguageDescription {
    ...
    public String[] getKeywords() {
        return new String[]{
                // Groovy 关键字（包含 Java 关键字 + Groovy 特有）
                ...
                "it", "long", "native", "new", "null", "package", "private", "protected",
