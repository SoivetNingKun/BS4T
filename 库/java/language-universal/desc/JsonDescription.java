...
public class JsonDescription implements LanguageDescription {
    ...
    public boolean isLineCommentStart(char a, char b) {
        // JSON does not support line comments
        return false;
    }

    @Override
    public boolean isLongCommentStart(char a, char b) {
        // JSON does not support block comments
        return false;
    }
    ...
    public String[] getKeywords() {
        // JSON has no keywords, but you can add true/false/null if needed
        return new String[0];
    }
