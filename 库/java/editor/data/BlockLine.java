...
public class BlockLine {
    ...
    public static final Comparator<BlockLine> COMPARATOR_END = new Comparator<BlockLine>() {
        public int compare(BlockLine a, BlockLine b) {
    ...
    public static final Comparator<BlockLine> COMPARATOR_START = new Comparator<BlockLine>() {
        public int compare(BlockLine a, BlockLine b) {
