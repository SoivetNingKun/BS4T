...
class Magnifier {
    ...
    public Magnifier(CodeEditor editor) {
        ...
        @SuppressLint("InflateParams") View popupView = LayoutInflater.from(editor.getContext()).inflate(editor.getContext().getResources().getIdentifier("magnifier_popup","layout",editor.getContext().getPackageName()), null);
        image = popupView.findViewById(editor.getContext().getResources().getIdentifier("magnifier_image_view","id",editor.getContext().getPackageName()));
