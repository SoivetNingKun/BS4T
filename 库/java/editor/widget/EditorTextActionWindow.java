...
class EditorTextActionWindow extends EditorBasePopupWindow implements View.OnClickListener, EditorTextActionPresenter {
    ...
    public EditorTextActionWindow(CodeEditor editor) {
        ...
        View root = LayoutInflater.from(editor.getContext()).inflate(editor.getContext().getResources().getIdentifier("text_compose_panel","layout",editor.getContext().getPackageName()), null);
        Button selectAll = root.findViewById(editor.getContext().getResources().getIdentifier("panel_btn_select_all","id",editor.getContext().getPackageName()));
        Button cut = root.findViewById(editor.getContext().getResources().getIdentifier("panel_btn_cut","id",editor.getContext().getPackageName()));
        Button copy = root.findViewById(editor.getContext().getResources().getIdentifier("panel_btn_copy","id",editor.getContext().getPackageName()));
        mPasteBtn = root.findViewById(editor.getContext().getResources().getIdentifier("panel_btn_paste","id",editor.getContext().getPackageName()));
        mCopyBtn = copy;
        mCutBtn = cut;
    ...
    public void onClick(View p1) {
        int id = p1.getId();
        if (id == mEditor.getContext().getResources().getIdentifier("panel_btn_select_all","id",mEditor.getContext().getPackageName())) {
            mEditor.selectAll();
        } else if (id == mEditor.getContext().getResources().getIdentifier("panel_btn_cut","id",mEditor.getContext().getPackageName())) {
            mEditor.copyText();
            if (mEditor.getCursor().isSelected()) {
                mEditor.getCursor().onDeleteKeyPressed();
            }
        } else if (id == mEditor.getContext().getResources().getIdentifier("panel_btn_paste","id",mEditor.getContext().getPackageName())) {
            mEditor.pasteText();
            mEditor.setSelection(mEditor.getCursor().getRightLine(), mEditor.getCursor().getRightColumn());
        } else if (id == mEditor.getContext().getResources().getIdentifier("panel_btn_copy","id",mEditor.getContext().getPackageName())) {
            mEditor.copyText();
            mEditor.setSelection(mEditor.getCursor().getRightLine(), mEditor.getCursor().getRightColumn());
        }
        hide();
