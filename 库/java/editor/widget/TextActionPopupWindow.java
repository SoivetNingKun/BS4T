...
public class TextActionPopupWindow extends TextComposeBasePopup implements View.OnClickListener, EditorTextActionPresenter {
    ...
    public TextActionPopupWindow(CodeEditor editor) {
        ...
        View root = LayoutInflater.from(editor.getContext()).inflate(editor.getContext().getResources().getIdentifier("text_compose_popup_window","layout",editor.getContext().getPackageName()), null);
        mSelectAll = root.findViewById(editor.getContext().getResources().getIdentifier("tcpw_material_button_select_all","id",editor.getContext().getPackageName()));
        mContainer = root.findViewById(editor.getContext().getResources().getIdentifier("text_compose_panel","id",editor.getContext().getPackageName()));
        mCutBtn = root.findViewById(editor.getContext().getResources().getIdentifier("tcpw_material_button_cut","id",editor.getContext().getPackageName()));
        copy = root.findViewById(editor.getContext().getResources().getIdentifier("tcpw_material_button_copy","id",editor.getContext().getPackageName()));
        mPasteBtn = root.findViewById(editor.getContext().getResources().getIdentifier("tcpw_material_button_paste","id",editor.getContext().getPackageName()));
