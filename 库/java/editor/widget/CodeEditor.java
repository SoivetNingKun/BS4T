    ...
    public void beginSearchMode() {
        class SearchActionMode implements ActionMode.Callback {
            ...
            public boolean onCreateActionMode(ActionMode p1, Menu p2) {
                ...
                p2.add(0, 0, 0, getContext().getResources().getIdentifier("next","string",getContext().getPackageName())).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_IF_ROOM);
                p2.add(0, 1, 0, getContext().getResources().getIdentifier("last","string",getContext().getPackageName())).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_NEVER);
                p2.add(0, 2, 0, getContext().getResources().getIdentifier("replace","string",getContext().getPackageName())).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_NEVER);
                p2.add(0, 3, 0, getContext().getResources().getIdentifier("replaceAll","string",getContext().getPackageName())).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_NEVER);
                ...
                p1.setCustomView(sv);
                sv.performClick();
                sv.setQueryHint(getContext().getString(getContext().getResources().getIdentifier("text_to_search","string",getContext().getPackageName())));
            ...
            public boolean onActionItemClicked(final ActionMode am, MenuItem p2) {
                switch (p2.getItemId()) {
                    ...
                    case 3:
                        ...
                        et.setHint(getContext().getResources().getIdentifier("replacement","string",getContext().getPackageName()));
                        new AlertDialog.Builder(getContext())
                                .setTitle(replaceAll ? getContext().getResources().getIdentifier("replaceAll","string",getContext().getPackageName()) : getContext().getResources().getIdentifier("replace","string",getContext().getPackageName()))
                                .setView(et)
                                .setNegativeButton(getContext().getResources().getIdentifier("cancel","string",getContext().getPackageName()), null)
                                .setPositiveButton(getContext().getResources().getIdentifier("replace","string",getContext().getPackageName()), (dialog, which) -> {
                                    if (replaceAll) {
